...
(function(skratch) {
	var toolDefaults = 
		{'tool': 'pen-tool', 'size':0.4, 'lightness' : 0.4,
		'colorA': 0.5, 'colorB': 0.6, 'opacity': 0.7, 'background-image':'backgrounds/0.json', 
		'rgbaColorString':'', 'colorRed':0, 'colorGreen':0, 'colorBlue':0},
		
		isDrawing = false,
		mice = {x:[], y:[]},
		cp = {x:[], y:[]},
		// Pencil-specific variables
		size, opacity, angle, 
		thisx, thisy, thisrate, 
		sample, qx = [], qy = [], brushSize,
		particlesz, thisrate,
