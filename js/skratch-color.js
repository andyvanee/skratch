...
(function (skratch) {
	// Each color component sets up it's own view from a jQuery selector
	// and catches it's own mouse events
	...
	skratch.setColor = function(capture){
		...
		skratch.tools['rgbaColorString'] = "rgba(" + red.toString() + "," + green.toString() + "," + blue.toString() + "," + skratch.tools['opacity'].toString() + ")";
	...
	var lGradient = function(type, gradient){
		...
		case ('w'):
			...
			+  "color-stop(1, rgba(" + gradient[1][0] + "," + gradient[1][1] + "," + gradient[1][2] +  "," + gradient[1][3] + ")))";
			break;
		case ('m'):
			g = "-moz-linear-gradient(center top, rgba("
			+ gradient[0][0] + "," + gradient[0][1] + "," + gradient[0][2] +  "," + gradient[0][3] + ") 0%,"
			+  "rgba(" + gradient[1][0] + "," + gradient[1][1] + "," + gradient[1][2] +  "," + gradient[1][3] + ") 100%)";
			break;
		default: 
